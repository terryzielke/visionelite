...
$program_program_info = get_post_meta( get_the_id(), 'program_program_info', true );
$program_format_info = get_post_meta( get_the_id(), 'program_format_info', true );
$program_expectation_info = get_post_meta( get_the_id(), 'program_expectation_info', true );
?>
